...
c
     ...
     &   'h','deg'/,timev/'LT','UT'/,coorv/'geog','geom'/
...
c          jf(7)=.false.      ! t=tops f10.7<188 f=unlimited
...
3292    format(A8,' option is used for the electron temperature')
